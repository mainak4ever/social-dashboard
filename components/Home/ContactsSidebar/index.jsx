...
import { pendingRequests, suggestedContacts } from './ContactsData';
...
const RightSidebar = () => {
  ...
  const handleAcceptRequest = (id) => {
    // Logic to accept friend request can be added here
  ...
  const handleDeclineRequest = (id) => {
    // Logic to decline friend request can be added here
  ...
  return (
    <div className="w-full h-full flex flex-col text-[rgba(255,255,255,0.69)]">
      <h2 className="mb-4 text-sm font-thin">SUGGESTED CONTACTS</h2>
      <div className="flex-grow overflow-y-scroll text-xs" style={{scrollbarWidth: "none"}}>
      ...
      {requests.length > 0 && (
        <div className='mt-5 border-t border-[rgb(50,50,50)]  max-h-[250px]' >
          <h2 className="mt-4 mb-4 text-sm font-thin">PENDING REQUEST</h2>
